...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<span class="l"> 
				<a href="javascript:;" onclick="datadel('<?php echo Url('Manager/del_role'); ?>')" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> 
				<a class="btn btn-primary radius" href="javascript:;" onclick="admin_role_add('添加角色','<?php echo Url("Manager/save_role"); ?>','800')"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a> 
			</span> 
			...
			<table class="table table-border table-bordered table-hover table-bg">
				...
				<tbody>
					...
					<tr class="text-c">
						<td class="destory_input"><input type="checkbox" value="<?php echo $vo['role_id']; ?>" name=""></td>
						<td><?php echo $vo['role_id']; ?></td>
						<td><?php echo $vo['role_name']; ?></td>
						<td><a href="#">admin</a></td>
						<td><?php echo $vo['role_note']; ?></td>
						<td class="f-14"><a title="编辑" href="javascript:;" onclick="admin_role_edit('角色编辑','<?php echo Url('Manager/edit_role',array('id'=>$vo['role_id'])); ?>','1')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
						<a title="删除" href="javascript:;" onclick="admin_permission_del('<?php echo Url('Manager/del_role'); ?>','<?php echo $vo['role_id']; ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
					</tr>
