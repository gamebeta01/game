<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"G:\www11\gamebeta01\public/../application/admin\view\manager\edit_role.html";i:1494428881;s:69:"G:\www11\gamebeta01\public/../application/admin\view\public\head.html";i:1494075465;s:69:"G:\www11\gamebeta01\public/../application/admin\view\public\foot.html";i:1493534055;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<form action="" method="post" class="form form-horizontal" id="form-admin-role-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $role['role_name']; ?>" placeholder="" id="role_name" name="role_name" datatype="*4-16" nullmsg="角色名称不能为空">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $role['role_note']; ?>" placeholder="" id="role_note" name="role_note">
			</div>
		</div>
		<div class="row cl">
					...
					<dd>
						...
						<dl class="cl permission-list2">
							...
							<dd>
								...
								<label class="">
									<?php 
									if(in_array($vp['power_id'],$role['role_power'])){
									...
									?>
									<input type="checkbox" value="<?php echo $vp['power_id']; ?>" name="role_power[]" id="user-Character-0-0-0" <?php echo $check;?>>
